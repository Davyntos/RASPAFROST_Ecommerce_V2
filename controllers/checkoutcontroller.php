...
class CheckoutController {
    ...
    public function mostrarCheckout() {
        ...
        // Se inicia la sesión de forma segura verificando si no está activa
        // para poder acceder a los datos del usuario y al carrito de compras.
    ...
    public function procesarPago() {
        ...
        // Se inicia la sesión de forma segura verificando si no está activa
        // para acceder al usuario autenticado y al carrito de compras.
        if (session_status() === PHP_SESSION_NONE) {
            session_start();
        }
    ...
    public function confirmacion() {
        ...
        // Se inicia la sesión de forma segura verificando si no está activa
        // para obtener el ID del pedido generado.
        if (session_status() === PHP_SESSION_NONE) {
            session_start();
        }
